---
title: "Chinese Factory Audit Checklist: What to Verify Before Your First Order"
description: "A practical pre-order factory audit checklist — what to check remotely, what to verify on a video call, and when to pay for a third-party audit. Real costs and red flags."
pubDate: 2025-05-22
...
1. **The front gate with the company name sign visible** — confirms address matches license
2. **The receptionist or office area** — should have the company name on the wall
3. **The production floor** — workers actually working, not empty machines
4. **Specifically, the line that makes your product** — ask them to show the machine running on a similar SKU
5. **QC station** — should exist as a physical station with people
6. **The warehouse / shipping area** — packed cartons with shipping labels in English suggest real export experience
7. **The R&D / sample room** — for custom products, this should look organized, not theatrical
...
I'll skip if any one of those fails. The cost of finding another supplier is hours; the cost of recovering from a bad one is weeks and dollars. See [Alibaba supplier went silent recovery](/blog/alibaba-supplier-went-silent-recovery/) for the math on why prevention beats cure.

## Related reading

- [How to verify Alibaba suppliers: red flags and green flags](/blog/how-to-verify-alibaba-suppliers/)
- [China product inspection guide](/blog/china-product-inspection-guide/)
- [NNN agreement with Chinese suppliers](/blog/nnn-agreement-chinese-suppliers/)
- [Communicating with Chinese suppliers](/blog/communicating-with-chinese-suppliers/)
