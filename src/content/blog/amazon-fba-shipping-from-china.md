---
title: "Amazon FBA Shipping from China: The Complete Process (2025)"
description: "How to ship products from Chinese suppliers directly to Amazon FBA warehouses — covering freight options, prep requirements, labeling, and common mistakes to avoid."
pubDate: 2025-05-11
category: "Shipping"
...
1. Go to **Inventory → Send/Replenish Inventory**
2. Select your products and quantities
3. Amazon assigns warehouse destination(s) — note that Amazon may split your shipment across multiple warehouses
4. Generate FBA labels for each master carton
5. Download FNSKU labels if not already on products
